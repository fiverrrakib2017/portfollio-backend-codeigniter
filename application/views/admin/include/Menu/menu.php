                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <a href="<?= base_url('education');?>" class="waves-effect">
                                    <i class="fas fa-solid fa-user-graduate"></i>
                                        <span>Education</span>
                                    </a>
                                </li> 
                                <li>
                                    <a href="<?= base_url('experience');?>" class="waves-effect">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <a href="<?= base_url('about/section/one');?>" class="waves-effect">
                                    <i class="mdi mdi-arrow-right-bold-circle"></i>
                                        <span>Section 1</span>
                                    </a>
                                </li>                             
                                ...
                                <li>
                                    <a href="<?= base_url('about/section/three');?>" class="waves-effect">
                                    <i class="mdi mdi-arrow-right-bold-circle"></i>
                                        <span>Section 3</span>
                                    </a>
                                </li>                             
